...
Public Class FormRegistrarTomaMuestra
    ...
    Private Sub poblarDataGridOrdenes()
        ...
        If Not oRegistroTM.listaDetallesOrdLab.Count = 0 Then
            For Each detalleOrden As DetalleLaboratorio In oRegistroTM.listaDetallesOrdLab
    ...
    Private Sub guardarRecepcionMuestra()
        oRegistroTM.listaDetallesSeleccionados = New DetalleLaboratorio(DgvDetallesOrden.SelectedRows.Count - 1) {}
        ...
        For Each row As DataGridViewRow In DgvDetallesOrden.SelectedRows
            ...
            Dim oDetOrLabAux As DetalleLaboratorio = New DetalleLaboratorio()
